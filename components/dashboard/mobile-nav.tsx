...
export function MobileNav() {
    ...
    return (
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="left" className="w-[300px] border-r border-slate-800/60 bg-[#0A101C] p-0 text-slate-200">
                <SheetTitle className="sr-only">Mobile Navigation</SheetTitle>
                <div className="p-6 border-b border-slate-800/60 flex justify-between items-center relative overflow-hidden">
